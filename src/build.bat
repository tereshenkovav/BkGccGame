...
pdp11-none-aout-gcc.exe -std=gnu2x -fomit-frame-pointer -msoft-float -fcprop-registers -fPIC -nostartfiles -nodefaultlibs -nostdlib -m10 -O2 -c -o bk0010_rtl.o bk0010_rtl.c
pause
...
pause
pdp11-none-aout-ld -T a.out.ld -Map bkgccgame.map -o bkgccgame_en.out crt0.o bkgccgame_en.o memory.o bk0010_rtl.o
pdp11-none-aout-ld -T a.out.ld -Map bkgccgame.map -o bkgccgame_ru.out crt0.o bkgccgame_ru.o memory.o bk0010_rtl.o
pause
mkdir ..\bin
